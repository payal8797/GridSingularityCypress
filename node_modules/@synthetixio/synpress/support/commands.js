...
Cypress.Commands.add('Register',(username, email, password) => {
  ...
  cy.xpath('//input[@name="name"]').type(username)
  cy.xpath('//input[@name="email"]').type(email)
  cy.xpath('//input[@name="password"]').type(password)
  cy.xpath('//input[@name="interest"]').click()
  cy.xpath('//button[text()="Prosumer"]').click()
  cy.xpath('//div[@class="recaptcha-checkbox-border"]').click()
  cy.xpath('//*[@name="termsAccepted"]/following::div[1]').click()
  cy.xpath('//button[@type="submit"]').click()
});

Cypress.Commands.add('Logout',() => {
  cy.xpath('//*[@class="UserAvatar_profileBtn__SUVMr"]').click()
